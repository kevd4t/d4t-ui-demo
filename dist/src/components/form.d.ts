...
declare const FormLabel: React.ForwardRefExoticComponent<Omit<Omit<LabelPrimitive.LabelProps & React.RefAttributes<HTMLLabelElement>, "ref">, "placeholder"> & React.RefAttributes<HTMLLabelElement>>;
