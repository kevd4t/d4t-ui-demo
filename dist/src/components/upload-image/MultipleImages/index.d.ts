...
export declare const MultipleImages: ({ label, setUploadImages, format, uploadLabel, tabIndexs, emptyClassName, imageContainerClassName, zoom, compress }: IMultipleUploadImageProps) => JSX.Element;
export {};
