...
import { FormEditDriver } from '@/components/page/ajustes/choferes/FormEditDriver'
...
const EditDriverPage = () => {
  ...
  return (
    <>
      ...
      { driver?.results && (<FormEditDriver driver={driver.results as IDriver} />) }
    </>
  )
}
...
EditDriverPage.getLayout = function getLayout (page: ReactElement) {
  return (
    <AuthenticatedLayout title={`${ROUTES.DRIVERS.EDIT.TITLE} | ${siteConfig.TITLE}`}>
      {page}
    </AuthenticatedLayout>
  )
}
