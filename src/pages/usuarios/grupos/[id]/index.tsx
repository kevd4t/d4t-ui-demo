...
const DetailUserGroupPage = () => {
  ...
  return (
    <>
      <HeaderPage allowGoBack title={`Detalle de Usuario ${router.query.id}`} />
    </>
  )
}

DetailUserGroupPage.getLayout = function getLayout (page: ReactElement) {
  return (
...
export default DetailUserGroupPage
