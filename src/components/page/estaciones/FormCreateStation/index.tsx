...
export const FormCreateStation = () => {
  ...
  const { data, error, isLoading: isLoadingUserGroups, fetcher } = useFetch<IFetchDataTable<IUserGroup>>('/api/stations/trucks')

  const pagination = {
    pageSize,
    pageIndex,
    setPagination,
    labels: { pluralItem: 'Camiones', singularItem: 'Camion' }
  }
