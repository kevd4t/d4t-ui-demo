...
import type { IFetchDataTable, ReactNode, ICreateGPSMark, IGPSMark, IGPSModel, ITruck, IFormCreateGPSDevice, IFleet } from '@/lib/types'
...
export const FormCreateGPSDevice = () => {
